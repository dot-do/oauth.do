...
export const IdentityProvider = ({ children }: { children: React.ReactNode }) => {
  return React.createElement(
    ...
    React.createElement('div', { 'data-testid': 'authkit-provider' }, React.createElement('div', { 'data-testid': 'workos-widgets' }, children)),
  )
}
...
export const useAuth = () => ({
  ...
  getSignInUrl: async () => 'https://id.org.ai/sign-in',
  getSignUpUrl: async () => 'https://id.org.ai/sign-up',
})
...
export const SignOutButton = ({ children, className }: { children?: React.ReactNode; className?: string }) => {
...
export const OrganizationSwitcher = ({ authToken, switchToOrganization }: { authToken: any; switchToOrganization: any }) => {
