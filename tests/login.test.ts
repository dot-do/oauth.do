...
describe('Login Module', () => {
  ...
  describe('ensureLoggedIn()', () => {
    ...
    it('should trigger login flow if not logged in', async () => {
      ...
      expect(pollForTokens).toHaveBeenCalledWith(mockDeviceResponse.device_code, mockDeviceResponse.interval, mockDeviceResponse.expires_in)
  ...
  describe('forceLogin()', () => {
    ...
    it('should return new token after forced login', async () => {
      ...
      const mockDeviceResponse: DeviceAuthorizationResponse = {
        ...
        user_code: 'EFGH-5678',
        verification_uri: 'https://id.org.ai/device',
        verification_uri_complete: 'https://id.org.ai/device?user_code=EFGH-5678',
        expires_in: 600,
        interval: 5,
      }
  ...
  describe('Print output', () => {
    it('should use custom print function', async () => {
      ...
      const mockDeviceResponse: DeviceAuthorizationResponse = {
        ...
        user_code: 'TEST-CODE',
        verification_uri: 'https://id.org.ai/device',
        verification_uri_complete: 'https://id.org.ai/device?user_code=TEST-CODE',
        expires_in: 600,
        interval: 5,
      }
